...
function N(t, e) {
  for (
    ...
    n && (n === Ht.ghost || "none" === _(n, "display") || (e && !b(n, e)));
...
function Ht(t, e) {
  ...
  var n = {
    ...
    supportPointer:
      !1 !== Ht.supportPointer && "PointerEvent" in window && (!h || f),
...
((Ht.prototype = {
  ...
  _triggerDragStart: function (t, e) {
    ((e = e || ("touch" == t.pointerType && t)),
      !this.nativeDraggable || e
        ...
        : (v($, "dragend", this), v(tt, "dragstart", this._onDragStart)));
    try {
      document.selection
        ? Gt(function () {
      ...
      if (
        ...
        u &&
          ...
          (d
            ? h || (i = Q !== tt)
            : ut === this ||
              ((this.lastPutMode = ct.checkPull(this, u, $, t)) &&
                c.checkPut(this, u, $, t))))
      ) {
        if (
        ...
        if (
          ...
          var b,
            ...
            T = r ? "top" : "left",
            x = M(l, "top", "top") || M($, "top", "top"),
            P = x ? x.scrollTop : void 0;
          if (
            (bt !== l &&
              ((y = o[T]), (Ct = !1), (Tt = (!C && s.invertSwap) || E)),
          ...
          if (0 === b || D === l) return K(!1);
          ((bt = l), (yt = b));
          var R = l.nextElementSibling,
            X = !1,
            B = Lt(tt, a, $, n, l, o, t, (X = 1 === b));
          if (!1 !== B)
            return (
              (1 !== B && -1 !== B) || (X = 1 === B),
              (Ot = !0),
              ...
              X && !R
                ? a.appendChild($)
                : l.parentNode.insertBefore($, X ? R : l),
              x && Y(x, 0, P - x.scrollTop),
              (Q = $.parentNode),
              void 0 === y || Tt || (wt = Math.abs(y - O(l)[T])),
              W(),
              K(!0)
            );
        }
    ...
    function K(e) {
      return (
        ...
        e &&
          ...
          p !== f &&
            (S($, ut ? ut.options.ghostClass : u.options.ghostClass, !1),
            S($, s.ghostClass, !0)),
          ut !== p && p !== Ht.active
            ? (ut = p)
        ...
        s.dragoverBubble ||
          t.rootEl ||
          l === document ||
          ($.parentNode[L]._isOutsideThisEl(t.target), !e && Ft(t)),
  ...
  _offMoveEvents: function () {
    (m(document, "mousemove", this._onTouchMove),
      ...
      m(document, "dragover", Ft),
      m(document, "mousemove", Ft),
      m(document, "touchmove", Ft));
  },
      ...
      Ht.eventCanceled ||
        ...
        t &&
          ...
          $ &&
            ...
            mt &&
              !Et &&
              S($, ut ? ut.options.ghostClass : this.options.ghostClass, !1),
          ...
          ? ((D =
            ...
            (E =
              ...
              ("auto" === T.overflowY ||
                ...
                "visible" === T.overflowY)))
          : ((D =
              y < S && ("auto" === T.overflowX || "scroll" === T.overflowX)),
            (E =
              w < C && ("auto" === T.overflowY || "scroll" === T.overflowY)));
        var N =
            D &&
            (Math.abs(b - r) <= l && M + y < S) - (Math.abs(m - r) <= l && !!M),
          I =
            E &&
            (Math.abs(v - a) <= l && A + w < C) - (Math.abs(g - a) <= l && !!A);
  ...
  return (
    (t.prototype = {
      ...
      clone: function (t) {
        ...
        this.isMultiDrag &&
          (this.options.removeCloneOnHide ||
            (ge.length && de === e && (De(!0, n), o("clone"), i())));
      },
      ...
      revert: function (t) {
        ...
        ge.length > 1 &&
          (ge.forEach(function (t) {
            (o.addAnimationState({ target: t, rect: be ? O(t) : i }),
              j(t),
              (t.fromRect = i),
      ...
      dragOverCompleted: function (t) {
        ...
        if (o) {
          if (
            ...
            l.animation &&
              ge.length > 1 &&
              (be || (!n && !i.options.sort && !a)))
          ) {
            var s = O(he, !1, !0, !0);
            (ge.forEach(function (t) {
              t !== he && (F(t, s), r.appendChild(t));
            }),
              (be = !0));
          }
          if (!n)
        ...
        if (e) {
                          ...
                          (a &&
                            ("function" == typeof a
                              ...
                              : a.split(",").some(function (t) {
                                  return w(u[r], t.trim(), o, !1);
                                }))) ||
                            (S(u[r], c.selectedClass, !0),
                            ge.push(u[r]),
                            U({
                              sortable: i,
                              rootEl: n,
          ...
          if (ye && this.isMultiDrag) {
            if (((be = !1), (o[L].options.sort || o !== n) && ge.length > 1)) {
              var f = O(he),
                p = I(he, ":not(." + this.options.selectedClass + ")");
              if (
                (!me && c.animation && (he.thisAnimationDuration = null),
      ...
      utils: {
        select: function (t) {
          ...
          e &&
            e.options.multiDrag &&
            !~ge.indexOf(t) &&
            (de && de !== e && (de.multiDrag._deselectMultiDrag(), (de = e)),
        ...
        deselect: function (t) {
          ...
          e &&
            e.options.multiDrag &&
            ~n &&
            (S(t, e.options.selectedClass, !1), ge.splice(n, 1));
        },
      },
      eventProperties: function () {
        var t = this,
    ...
    return (
      (t.prototype = {
        ...
        _handleAutoScroll: function (t, e) {
          ...
          if (
            ((Qt = t), e || this.options.forceAutoScrollFallback || u || c || h)
          ) {
